...
from tools import (
    ...
    send_sms, send_message_to_client,
...
TOOLS = [
    ...
    {"type": "function", "function": {"name": "send_message_to_client", "description": "Send a message to the current client via their preferred channel (SMS or WhatsApp).", "parameters": {"type": "object", "required": ["message"], "properties": {"message": {"type": "string"}}}}},
